...
import backend.dados.drone.DroneCargaViva;
import frontend.Gui;
import java.awt.*;
...
public class Card4 extends JPanel implements ActionListener {
    ...
    public Card4(Gui gui, App app, CardLayout cardLayout, JPanel painel) {
        this.gui = gui;
        this.app = app;
        ...
        JLabel rotulo = new JLabel("Cadastra drone de carga viva");
        ...
        this.add(criarPainelComRadioButton("Climatizado:", radioSim = new JRadioButton("Sim"), radioNao = new JRadioButton("Não")));
        ...
        if (e.getSource() == volta) {
            ...
            try{
                ...
                if(radioSim.isSelected()){
                    ...
                    throw new Exception("Selecione uma opção para a climatização!");
                }
                
                DroneCargaViva drone = new DroneCargaViva(codigo, custoFixo, autonomia, pesoMaximo, climatizado);
                ...
                JOptionPane.showMessageDialog(null, "Drone cadastrado com sucesso", "Cadastro de drone de carga viva", JOptionPane.INFORMATION_MESSAGE);
            }catch(NumberFormatException exception){
                JOptionPane.showMessageDialog(null, "Os campos de código, custo fixo, autonomia e peso máximo devem ser preenchidos com números válidos", "Cadastro de drone de carga viva", JOptionPane.ERROR_MESSAGE);
            }catch(Exception exception){
                JOptionPane.showMessageDialog(null, exception.getMessage(), "Cadastro de drone de carga viva", JOptionPane.ERROR_MESSAGE);
            }
